...
That said, I'm sure there's a "cleverer" way to solve this, with probably less conditional branching code-mess. That said, this was the first thing that came to mind when working through the problem organically. It works, it's mostly readable, so it's what I'm sticking with 😎
