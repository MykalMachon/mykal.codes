...
The "hard-part" of this challenge for me was the ingestion of data into usable structures. The actual task of moving the things around was trivial. These are my-least favorite kind of advent of code challenges because it feels a bit like [artificial difficulty in video games](https://videogaming.fandom.com/wiki/Artificial_Difficulty#:\~:text=Artificial%20Difficulty%20(also%20referred%20to,increase%20the%20likelihood%20of%20failure.). 
