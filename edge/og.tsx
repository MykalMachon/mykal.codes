    ...
    (
      ...
      >
        ...
        >
          ...
          <p>Mykal Machon - Page</p>
        </header>
        <main style={{ display: 'flex', flexDirection: 'column' }}>
          <h1 style={{ fontSize: '64px' }}>Mykal Machons Digital Garden</h1>
          <p style={{ fontSize: '32px' }}>
            Where I post about whatever Im doing.
          </p>
        </main>
        <footer style={{ display: 'flex', flexDirection: 'row' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <p
                style={{ fontSize: '24px', fontWeight: 'bold', margin: '0em' }}
              >
                13 minutes
              </p>
            </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <small style={{ fontSize: '18px' }}>Tags:</small>
              <p
                style={{ fontSize: '24px', fontWeight: 'bold', margin: '0em' }}
              >
                #Personal
